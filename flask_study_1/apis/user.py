...
ns = Namespace('users', description='유저 관련 API')

user = ns.model('User', {'id': fields.Integer(required=True, description='유저 고유 번호'),
...
# /api/users
@ns.route('')
@ns.response(409, 'User Id is already exist')
